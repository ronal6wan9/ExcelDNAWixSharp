    ...
    public class CustomActions
    {
        ...
        public static string GetAddInName(string szXll32Name, string szXll64Name, string szOfficeVersionKey, double nVersion)
        {
            ...
            if (nVersion >= 14)
            {
                ...
                RegistryKey rkBitness = localMachineRegistry.OpenSubKey(@"Software\Microsoft\Office\" + szOfficeVersionKey + @"\Excel", false);
                if (rkBitness != null)
                {
                    ...
                    if (Environment.Is64BitOperatingSystem)
                    {
                        ...
                        rkBitness =
                            localMachineRegistry.OpenSubKey(
                                @"Software\Microsoft\Office\" + szOfficeVersionKey + @"\Excel", false);
                        if (rkBitness != null)
                        {
